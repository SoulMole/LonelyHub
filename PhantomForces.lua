...
local Library = loadstring(game:HttpGet("https://raw.githubusercontent.com/SoulMole/LonelyHub/main/UILibaray.lua"))()
...
CIELUVInterpolator = LoadStringUrl("https://raw.githubusercontent.com/SoulMole/LonelyHub/main/Utils.lua")
